...
public class AutoDraggable4 : MonoBehaviour, IDropHandler
{
    ...
    public Button nextButton; // Reference to the button to proceed to the next scene

    private string[] correctTagOrder = { "(", "Q1", "H", "I", "Q1", ")" };
    ...
    {
        // Activate the next button to proceed to the next scene
        if (nextButton != null)
        {
        ...
        {
            Debug.LogWarning("Next button reference is not set.");
        }
    }
}
