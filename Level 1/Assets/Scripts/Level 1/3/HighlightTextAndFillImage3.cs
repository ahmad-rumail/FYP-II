...
public class HighlightTextAndFillImage3 : MonoBehaviour
{
    ...
    private void Start()
    {
        StartCoroutine(HighlightTextAndFillImage3Coroutine());
    }

    private IEnumerator HighlightTextAndFillImage3Coroutine()
    {
        while (true)
        {
